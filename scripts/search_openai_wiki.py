...
INDEX_NAMES = {
    "chunks":    "vector_index_large",
    #"chunks_v4": "vector_index_v4",
    #"chunks_v4_lite": "vector_index_v4_lite",
}

def search(query: str, collection: str = "chunks", model: str = "text-embedding-3-large", k: int = 5) -> dict:
    ...
    response = openai_client.embeddings.create(
        model=model,
        input=query   # no need to slice or halve the query
    )
