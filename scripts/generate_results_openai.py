...
"""
from search_openai import search
import json

PERMUTATIONS = [
    #{"collection": "chunks",    "model": "text-embedding-3-small"},
    {"collection": "chunks",    "model": "text-embedding-3-large"},
    #{"collection": "chunks",    "model": "voyage-4-lite"},
    #{"collection": "chunks_v4", "model": "text-embedding-3-small"},
