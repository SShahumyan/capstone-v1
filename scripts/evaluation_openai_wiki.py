...
with open("evaluation/raw_results_gemini.json", "r", encoding="utf-8") as f:
    raw_results = json.load(f)

PERMUTATIONS = [
    {"collection": "chunks",         "model": "gemini-embedding-2"}#,
...
with open("evaluation/report_gemini.json", "w", encoding="utf-8") as f:
